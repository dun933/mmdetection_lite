...
data_root = '/mnt/data2/yanghuiyu/DeepFashion2'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'coco/deepfashion2_train.json',
        img_prefix=data_root + 'train/image',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'coco/deepfashion2_val.json',
...
load_from = './work_dirs/cascade_rcnn_r50_fpn_1x/latest.pth'
resume_from = None
workflow = [('train', 1)]
