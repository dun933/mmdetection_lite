...
class CascadeRCNNLite(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeRCNNLite, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(CascadeRCNNLite, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(CascadeRCNNLite, self).show_result(data, result, **kwargs)
